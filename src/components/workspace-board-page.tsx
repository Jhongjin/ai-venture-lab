  ...
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="mx-auto grid w-full max-w-[1480px] gap-4 px-4 py-4 sm:px-6">
        <header className="avl-card px-4 py-4 sm:px-5">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="min-w-0">
              ...
              <h1 className="text-[16px] font-semibold tracking-tight text-slate-950 sm:text-[18px]">아이디어 실행 보드</h1>
              <p className="mt-1 max-w-3xl text-[12px] leading-5 text-slate-600">
                아이디어 발굴부터 검증, 실행 패키지 정리까지 한 흐름으로 이어가는 작업 공간입니다.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-2 xl:min-w-[360px] xl:grid-cols-4">
              {headerStats.map(([label, value]) => (
                <div key={label} className="avl-surface-subtle px-3 py-2">
