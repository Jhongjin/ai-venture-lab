...
export function VentureConsoleShell({
  ...
  return (
    <section className="grid gap-5 xl:grid-cols-[172px_minmax(0,1fr)]">
        ...
        <div className="border-b border-slate-200 pb-4">
          ...
          <div className="mt-4 rounded-2xl border border-slate-200 bg-white px-3 py-3">
            <div className="flex items-baseline justify-between gap-2">
              ...
              <div className="text-xs font-semibold text-slate-500">{workflowProgress}%</div>
            </div>
            <div className="mt-2 text-lg font-semibold text-slate-950">
              {completedRequiredCount}/{requiredShellTasks.length}
            </div>
            <p className="mt-1 text-[11px] leading-5 text-slate-500">필수 단계 기준으로 현재 열려 있는 흐름입니다.</p>
          </div>
        </div>
            ...
            return (
              <div key={task.id}>
                ...
                <button
                  ...
                  disabled={isLocked}
                  className={`grid w-full grid-cols-[1.45rem_minmax(0,1fr)] gap-3 rounded-2xl border px-2.5 py-2.5 text-left transition ${
                    isCurrent
                ...
                >
                  ...
                  <span className="min-w-0">
                      <span className="flex items-center gap-2 text-[12px] font-semibold text-slate-950">
                      <Icon size={13} />
                      {task.label}
                    </span>
            ...
            <div className="min-w-0">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <h2 className="mt-2 max-w-4xl text-[20px] font-semibold tracking-tight text-slate-950 sm:text-[24px] sm:leading-[30px]">
              ...
              <div className="mt-5 grid gap-3 lg:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">AI가 먼저 준비하는 것</div>
