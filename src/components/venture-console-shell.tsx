  ...
  return (
    <section className="grid gap-5 xl:grid-cols-[220px_minmax(0,1fr)]">
      <aside className="avl-card-soft sticky top-4 max-h-[calc(100vh-2rem)] self-start overflow-y-auto p-3">
        <div className="border-b border-slate-200 pb-4">
          ...
          <div className="mt-3 flex items-center justify-between text-[11px] font-semibold text-slate-500">
            <span>
              {completedRequiredCount}/{requiredShellTasks.length} 단계
            </span>
            <span>{workflowProgress}% 완료</span>
          </div>
        </div>
            ...
            return (
              <div key={task.id}>
                ...
                <button
                  ...
                  disabled={isLocked}
                  className={`grid w-full grid-cols-[1.7rem_minmax(0,1fr)] gap-3 rounded-2xl border px-3 py-3 text-left transition ${
                    isCurrent
      ...
      <div className="min-w-0 space-y-5">
        <section className="avl-card-soft p-5 sm:p-6">
          ...
          <div className="mt-5 min-w-0">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <h2 className="mt-2 max-w-4xl text-[18px] font-semibold tracking-tight text-slate-950 sm:text-[22px] sm:leading-[30px]">
            ...
            <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
              ...
              <dl className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <dt className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">AI 준비</dt>
                  <dd className="mt-2 text-sm leading-6 text-slate-700">{activeCanvas.aiLead}</dd>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4">
                  <dt className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">산출물</dt>
                  <dd className="mt-2 text-sm leading-6 text-slate-700">{activeCanvas.deliverable}</dd>
                </div>
              </dl>
            </div>
