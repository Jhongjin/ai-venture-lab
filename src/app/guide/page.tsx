...
const menuGuide = [
  ...
  },
  {
    title: "마이페이지",
    route: "/profile",
    body: "표시 이름과 비밀번호를 수정하고, Venture Credits 잔여량, 이번 달 남은 제작 패스, 업그레이드가 필요한 순간과 Pro 관심 등록을 확인합니다.",
    icon: UserCircle,
  },
  {
    title: "실행 보드",
...
const boardSteps = [
  {
    ...
    body: "회의 메모, 대화 기록, 떠오른 아이디어를 붙여넣으면 AI가 먼저 볼 아이디어 한 건과 웹 서비스, 모바일 앱, 랜딩/웹사이트, 자동화 같은 결과물 형태를 함께 잡습니다. 개발 방식은 별도로 저장되어 모바일 앱으로 만들고 Cursor로 개발합니다처럼 보입니다.",
    icon: Sparkle,
  },
  {
...
const quickAnswers = [
  ...
  [
    "언제 크레딧을 쓰나요",
    `Free는 매월 ${FREE_MONTHLY_CREDITS}크레딧으로 시작합니다. 기본 ${FREE_PACKAGE_ARTIFACT_LIMIT}/${FULL_PACKAGE_ARTIFACT_COUNT} 제작 자료는 먼저 확인하고, 제품 기획서, 화면 구조, 디자인 기준, 기술 방향, 작업 순서, 외부 개발 도구 전달 파일까지 열 때 ${IDEA_BUILD_PASS_CREDITS}크레딧 제작 패스를 씁니다.`,
  ],
  ["Pro 관심 등록은 어디서 하나요", "마이페이지의 Venture Credits 요약에서 등록할 수 있습니다. STEP 5에서 잔여 크레딧이 부족할 때도 결제 없이 Pro 관심 기록만 남길 수 있습니다."],
        ...
        <section className="grid gap-px bg-slate-300 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="bg-white px-6 py-8 sm:px-8 sm:py-10">
            ...
            <p className="mt-5 max-w-[62ch] break-keep text-[15px] leading-7 text-slate-600">
              AI Venture Lab은 사용자가 모든 문서를 직접 채우는 도구가 아닙니다. 아이디어나 메모를 넣으면 AI가 사업성, 리스크, 검증 계획, 결과물 형태와 개발 방식을 먼저 정리하고, 사용자는 중요한 판단만 확인합니다.
            </p>
          </div>
