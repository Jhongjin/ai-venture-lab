  ...
  return {
    ...
    market_signals: [
      ...
      },
      {
        label: "검증 채널",
        finding: isB2b
          ? "운영 책임자나 실제 담당자가 현재 쓰는 도구, 반복 빈도, 전환 조건을 인터뷰로 확인해야 합니다."
          : "초기 사용자가 모이는 커뮤니티나 검색 경로에서 문제 표현과 대체 행동을 먼저 확인해야 합니다.",
      },
    ],
    competitor_map: [
      {
      ...
      {
        name: "수동 운영과 기존 업무 루틴",
        category: "비구매 대체재",
        threat: "medium",
        note: "새 도구를 도입하지 않고 기존 담당자, 메신저, 문서, 반복 확인으로 버티는 흐름도 실제 경쟁 대상입니다.",
      },
    ],
    entry_barrier_checks: [
      {
