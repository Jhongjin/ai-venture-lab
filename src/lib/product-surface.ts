...
export const productSurfaceProfiles: Record<ProductSurfaceKey, ProductSurfaceProfile> = {
  web_app: {
    ...
    iaHint: "대시보드, 핵심 입력, 결과 검토, 기록 상세, 설정/권한 화면을 기본 정보 구조로 둡니다.",
    ...
    handoffHint: "외부 제작 도구에는 라우트, 컴포넌트, Server Action/API 경계, 데이터 모델, smoke 명령을 함께 넘깁니다.",
  },
  mobile_app: {
    key: "mobile_app",
    label: "모바일 앱",
    ...
    iaHint: "온보딩, 홈, 핵심 행동, 알림/재방문, 기록 상세, 권한/설정 화면을 모바일 단일 흐름으로 둡니다.",
    ...
    handoffHint: "외부 제작 도구에는 모바일 화면 상태, 권한 요청, 푸시/분석 경계, 앱스토어 전 검증 명령을 함께 넘깁니다.",
  },
  web_site: {
    key: "web_site",
    label: "랜딩/웹사이트",
    ...
    iaHint: "첫 화면, 문제/제안, 신뢰 근거, 신청/예약, FAQ, 완료 후 후속 안내를 공개 페이지 구조로 둡니다.",
    ...
    handoffHint: "외부 제작 도구에는 섹션 순서, 전환 문구, 폼 저장/알림, SEO, 신청 후 처리 기준을 함께 넘깁니다.",
  },
  automation: {
    key: "automation",
    label: "업무 자동화",
    ...
    iaHint: "입력 출처, 처리 대기열, 자동 처리 결과, 사람 검토, 로그/실패 복구, 리포트 화면을 기본 구조로 둡니다.",
    ...
    handoffHint: "외부 제작 도구에는 트리거, 처리 단계, 승인/재시도, 실패 로그, 수동 대체 경로를 함께 넘깁니다.",
  },
  operator_console: {
    ...
    iaHint: "현황판, 리스트/필터, 상세, 상태 변경, 담당/권한, 감사 로그 화면을 운영 정보 구조로 둡니다.",
    ...
    handoffHint: "외부 제작 도구에는 테이블/상세 계약, 상태 전환, 권한 정책, 감사 로그, 운영 smoke를 함께 넘깁니다.",
  },
  mcp_handoff: {
    key: "mcp_handoff",
    label: "제작 도구 연동",
