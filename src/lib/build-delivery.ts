...
export const externalBuildToolProfiles: Record<ExternalBuildToolKey, ExternalBuildToolProfile> = {
  ...
  codex: {
    ...
    handoffSteps: [
      ...
      "보고 내용을 Venture Lab 최종 실행 화면의 백업 반영 영역에 붙여 상태를 갱신합니다.",
    ],
    handoffNote: "Codex는 현재 패키지 전달 방식입니다. 자동 상태 반영은 Cursor부터 제공하고, Codex 전용 동기화는 별도 연결이 필요합니다.",
  },
  claude_code: {
    key: "claude_code",
    label: "Claude Code",
    ...
    handoffSteps: [
      ...
      "완료 보고를 Venture Lab에 백업 반영해 작업 상태를 맞춥니다.",
    ],
    handoffNote: "Claude Code는 현재 패키지 전달 방식입니다. 자동 상태 반영은 Cursor부터 제공하고 있습니다.",
  },
  antigravity: {
    key: "antigravity",
    ...
    handoffNote: "Antigravity는 현재 패키지 전달 방식입니다. 자동 상태 반영은 Cursor부터 제공하고 있습니다.",
  },
  generic_mcp: {
    key: "generic_mcp",
    label: "범용 MCP 전달",
