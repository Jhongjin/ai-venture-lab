...
$checks = @(
  ...
  @{
    Path = "src/lib/development-package-drafts.ts"
    Terms = @(
      "Security Rules",
  ...
  @{
    Path = "docs/CONTROLLED_BETA_FEEDBACK_TRIAGE.md"
    Terms = @(
      "controlled_beta_feedback_triage",
      "feedback_to_work_queue_guidance",
      "summary_only_feedback_input",
      "no_single_session_launch_claim",
      "triage_intake_preconditions",
      "synthetic_or_approved_beta_data",
      "no_real_pii_beta_session",
      "regulated_advice_scoped_out",
      "smoke_evidence_not_user_feedback",
      "scope_risk_if_boundary_missing",
      "beta_feedback_triage",
      "copy_or_flow_fix",
      "evidence_gap",
      "workflow_gap",
      "scope_risk",
      "security_launch_gate_queue",
      "beta_feedback_severity",
      "p0_private_or_secret_exposure",
      "p1_core_path_blocker",
      "p2_confidence_or_copy_gap",
      "p3_wait_for_more_signal",
      "feedback_action_rules",
      "no_feature_from_single_p3",
      "single_p1_next_action_failure_actionable",
      "evidence_gap_creates_artifact_queue",
      "workflow_gap_creates_product_qa_queue",
      "scope_risk_immediate_security_queue",
      "feedback_work_queue_shape",
      "controlled_beta_session_source",
      "done_when_required",
      "verification_required",
      "no_raw_private_feedback_payload",
      "feedback_triage_decision_output",
      "fix_now",
      "batch_next",
      "watch",
      "security_review",
      "ignore_for_now",
      "feedback_triage_exit_criteria",
      "bucket_and_severity_required",
      "safety_boundary_checked",
      "owner_and_next_action_required"
    )
  },
  @{
