...
| Billing credit smoke | `pnpm smoke:billing` | Anonymous negative-path check | Confirms credit summary and build-pass unlock reject unauthenticated requests. Does not spend credits. |
