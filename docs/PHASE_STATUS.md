...
| --- | --- | --- | --- | --- |
| 2026-05-22 | Hardened market scan smoke timeout for web-search latency | Current commit | Pending Git integration after push | Pending `node --check scripts/smoke_market_scan.mjs`, `pnpm smoke:market`, `pnpm release:check` |
