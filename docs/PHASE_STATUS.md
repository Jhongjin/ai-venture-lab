...
| --- | --- | --- | --- | --- |
| 2026-05-25 | Updated the user test guide for current STEP 1 and list-management flows | Current commit | Docs-only; no runtime deploy required beyond Git sync | `pnpm release:check`; guide now matches context-sensitive STEP 1 actions and checkbox bulk controls on active/deleted idea lists |
