...
| --- | --- | --- | --- | --- |
| 2026-05-26 | Clarified Cursor Workspace MCP manual activation step | `46b8edd` | Push to `main`, then production smoke after deployment | `node --check scripts/smoke_build_sync_tokens.mjs`, `pnpm typecheck`, `pnpm release:check`, `pnpm quality:full` |
