...
| --- | --- | --- | --- | --- |
| 2026-05-22 | Reduced first-run idea input actions to one visible execution path | Current commit | Pending Git integration after push | Pending production smoke and browser smoke; local `pnpm quality:full` passed |
