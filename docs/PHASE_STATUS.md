...
| --- | --- | --- | --- | --- |
| 2026-05-25 | Clarified the user test path for external connector setup downloads | `d398f39` | Docs-only; pushed to `main` pending | `pnpm release:check`; user test guide now checks that the selected tool downloads the matching `*-setup.ps1` file before project-root install |
