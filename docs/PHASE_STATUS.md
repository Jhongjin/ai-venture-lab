...
| --- | --- | --- | --- | --- |
| 2026-05-22 | Added market and competition auto-research smoke command | Current commit | Script/docs only; no runtime deploy required beyond Git integration | `node --check scripts/smoke_market_scan.mjs`, `pnpm smoke:market`, `pnpm release:check`; production smoke pending after push |
