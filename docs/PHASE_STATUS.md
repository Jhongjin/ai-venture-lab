...
| --- | --- | --- | --- | --- |
| 2026-05-25 | Added bulk restore and permanent delete controls to the deleted ideas list | Current commit | User-facing list-management change; production deploy required after commit | `pnpm lint`, `pnpm typecheck`, `pnpm quality:full`; deleted ideas now support checkbox selection, selected restore, and selected/all permanent delete with related records cleaned first |
