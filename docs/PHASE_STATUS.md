...
| --- | --- | --- | --- | --- |
| 2026-05-25 | Removed stale Cursor-only handoff copy from external tool messaging | `886fc0b` | Pushed to `main`; production smoke pending | `pnpm lint`, `pnpm typecheck`, `pnpm smoke:build-sync`; Cursor, Codex, Claude Code, and Google Antigravity now stay framed as the supported automatic sync paths |
